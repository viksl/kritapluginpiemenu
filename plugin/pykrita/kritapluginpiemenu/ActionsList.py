...
class ActionsList(QObject):
    ...
    actionsList = [
        ...
        {"name": "Create Blank Frame", "actionID": "add_blank_frame", "category": "Animation", "init": None, "callback": None, "resetCallback": None},
        {"name": "Create Duplicate Frame", "actionID": "add_duplicate_frame", "category": "Animation", "init": None, "callback": None, "resetCallback": None},
        {"name": "Remove Keyframe", "actionID": "remove_frames", "category": "Animation", "init": None, "callback": None, "resetCallback": None},
        {"name": "Previous Frame", "actionID": "previous_frame", "category": "Animation", "init": None, "callback": None, "resetCallback": None},
        {"name": "Next Frame", "actionID": "next_frame", "category": "Animation", "init": None, "callback": None, "resetCallback": None},
        {"name": "Previous Key Frame", "actionID": "previous_keyframe", "category": "Animation", "init": None, "callback": None, "resetCallback": None},
        {"name": "Next Key Frame", "actionID": "next_keyframe", "category": "Animation", "init": None, "callback": None, "resetCallback": None},
        {"name": "Last Frame", "actionID": "last_frame", "category": "Animation", "init": None, "callback": None, "resetCallback": None},
